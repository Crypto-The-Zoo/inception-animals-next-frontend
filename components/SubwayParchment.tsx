  ...
  const teamMembers = [
    {
      ...
      extraDescription: `A Friendly Yokai is Graduated from Sheridan, famously known as the "Harvard of animation", with an animation degree.`,
      imgSrc: "hare_1.jpg",
    },
    {
      name: "Alfredoo",
      title: "Co-founder & Engineer",
      description: `Previous a management consultant at Deloitte, now an engineer and emerging leader in developing and nurturing web3 projects. `,
      extraDescription: "Alfredoo brings experience from working at multiple major crypto companies while being a co-founder at both Flunks Inc. and Inception Animals.",
