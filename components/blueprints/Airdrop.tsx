...
const Airdrop: React.FC = () => {
  const renderLeadingText = () => {
    const contents: string[] = [
      `Inception Avatar Genesis Holders are entitled to airdrop collections on Flow via the holding Dapper Wallet account. Your Inception Avatar can be used as the pass/allowlist for future drops and free mints from Ube Studios Inc.`,
    ]
